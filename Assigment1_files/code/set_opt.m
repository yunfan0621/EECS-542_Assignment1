...
opt.wij.weight = 10; % weight for deformation term
opt.wij.x = opt.wij.weight * 1;
opt.wij.y = opt.wij.weight * 1;
opt.wij.theta = opt.wij.weight * 1;
opt.wij.s = opt.wij.weight * 1;
